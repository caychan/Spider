...
//    	System.out.println("HtmlNode 有参数");
    ...
    public HtmlNode() {
//    	System.out.println("HtmlNode meiyou参数");
        elements = null;
    }
    ...
    //*******************
    public Selectable linksOfImg(){
    	return xpath("//img/@src");
    }

    public Selectable linksOfSource(){
    	return xpath("//source/@src");
    }

/*    public Selectable linksOfLink(){
    	return xpath("//link/@href");
    }*/
...
//        	System.out.println("elementSelector has attribute .toString: "+elementSelector.toString());
        	
            List<Element> resultElements = new ArrayList<Element>();
            while (elementIterator.hasNext()) {

//            	System.out.println("elementIterator"+elementIterator.next());
...
//        	System.out.println("elementSelector has no attribute ");
